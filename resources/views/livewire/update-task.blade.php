<div class="modal fade" id="updateTaskModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Feladat szerkesztése</h5>
            ...
            <div class="modal-body">
                <div class="form-group m-t">
                    <form >
                        @csrf
                        <input type="hidden" name="task_id" wire:model="task_id"/>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click.prevent="update()">Feladat mentése</button>
            </div>
        </div>
    </div>
</div>
